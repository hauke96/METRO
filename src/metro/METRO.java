...
public class METRO implements ApplicationListener, InputProcessor
{
	 ...
	 *
	 * @param args
	 *            The console arguments that have no function here.
	 */
	...
	private void setSettings()
	{
		...
		try
		{
			...
			__SCREEN_SIZE = new Dimension(Integer.parseInt(settings.getOiginal(Settings.SCREEN_WIDTH).toString()), Integer.parseInt(settings.getOiginal(Settings.SCREEN_HEIGHT).toString()));
	...
	public boolean touchDragged(int screenX, int screenY, int pointer)
	{
		if (__dragMode)
		{
			Display.setLocation((screenX - __dragModeLastMousePosition.x) + Display.getX(), (screenY - __dragModeLastMousePosition.y) + Display.getY());
		}
		return false;
	}
	 ...
	 *
	 * @param field
	 *            The input field that should get the focus.
	 */
