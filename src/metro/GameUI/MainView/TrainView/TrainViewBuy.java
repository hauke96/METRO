...
public class TrainViewBuy extends ToolView
{
	 ...
	 * 
	 * @param areaOffset
	 *            The position of the right edge of the main dialog (to better determine positions).
	 * @param toolWidth
	 *            The width of the main dialog.
	...
	private void drawHeader()
	{
		...
		Draw.Line(METRO.__SCREEN_SIZE.width - _toolWidth + 25, _areaOffset.y + 435, METRO.__SCREEN_SIZE.width - _toolWidth + 25 + length, _areaOffset.y + 435);
	}
