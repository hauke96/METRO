...
public class WelcomeWindow extends Window
{
	 ...
	 * 
	 * @param titleImageTexture The title image.
	 */
	public WelcomeWindow(TextureRegion titleImageTexture)
	{
		super("Welcome to METRO - v" + METRO.__VERSION,
			new Rectangle(50,
				100, // same y-pos as title image
				500,
				530));

		Button button = new Button(
			new Rectangle((500 - (int)(titleImageTexture.getRegionWidth() * 0.4f)) / 2,
				(260 - (int)(titleImageTexture.getRegionWidth() * 0.4f)) / 2,
				(int)(titleImageTexture.getRegionWidth() * 0.4f),
				(int)(titleImageTexture.getRegionHeight() * 0.4f)),
			new Rectangle(0,
				0,
				titleImageTexture.getRegionWidth(),
				titleImageTexture.getRegionHeight()),
			titleImageTexture);
