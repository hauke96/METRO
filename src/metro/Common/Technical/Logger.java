...
public class Logger
{
	 ...
	 * 
	 * @param errorMessage The message to show.
	 * @param throwable An throwable object to show even more information.
	 */
	 ...
	 * 
	 * @param message The general message to display.
	 * @param tag The tag specified by the fields of the Logger class.
	 * @param stream The output stream (STD_ERR or STD_OUT)
	 */
	 ...
	 * @param message The general message to display.
	 * @param tag The tag specified by the fields of the Logger class.
	 * @param stream The output stream (std_err or std_in
	 * @param stackCounter The stack counter. Set this to -1 to not display the method that called uses the Logger.
	 */
