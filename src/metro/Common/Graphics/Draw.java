...
public class Draw
{
	 ...
	 *            The y-coord.
	 * @param width
	 *            The maximum width of the area where the text should be.
	 ...
	 *            The text whose size you want.
	 * @param font
	 *            The font that should be used to measure the size.
	 * @return The size as a Dimension (width, height).
	 */
	 ...
	 * @param width
	 *            The maximum width in pixel of the string.
	 ...
	 * 
	 * @param image
	 *            The TextureRegion (i call it "image" ;) ) that should be drawn.
	 * @param x
	 *            The x-coordinate (upper left corner)
	 * @param y
	 *            The y-coordinate (upper left corner)
	 */
	 ...
	 * 
	 * @param image
	 *            The TextureRegion (i call it "image" ;) ) that should be draw.
	 * @param position
	 *            The position as Rectangle of the image with x, y, width and height.
	 */
	 ...
	 * 
	 * @param image
	 *            The TextureRectangle (i call it "image" ;) ) from which an area should be drawn.
	 * @param position
	 *            The position of the image
	 * @param areaOnImage
	 *            The area on the image that should be drawn.
	 */
	 ...
	 * @param areaOnImage
	 *            The area of the image on the given texture.
