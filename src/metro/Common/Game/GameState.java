...
public class GameState
{
	 ...
	 *             An exception describing that there's to less money on the bank account to withdraw the given amount from it.
	 */
	 ...
	 * 
	 * @param amount
	 *            The amount of steps. Each step in-/decreases the {@code _baseNetSpacing} by 5 pixel.
	 */
