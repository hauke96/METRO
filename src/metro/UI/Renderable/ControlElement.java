...
public abstract class ControlElement extends ActionObservable
{
	 ...
	 * @param button
	 *            The button related to Buttons.xy.
	 ...
	 *            The y coordinate of the click.
	 * @param button
	 *            The button that had been clicke but has been released now.
	 */
	 ...
	 * 
	 * @param offset
	 *            The amount of pixel to move. This is NOT the new position, only an offset!
	 */
	 ...
	 * 
	 * @param amount
	 *            Positive or negative amount of steps since last frame.
	 */
