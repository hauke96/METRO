...
public class Panel extends StaticContainer
{
	 ...
	 * 
	 * @param area
	 *            The area of the panel including absolute position and size.
	 */
	 ...
	 *            The area of the panel including absolute position and size.
	 * @param drawBorder
	 *            The flag if the border should be drawed (true) or not drawed (false).
	 */
	 ...
	 * 
	 * @param drawBorder
	 *            True to draw the border, false to don't draw the border.
	 */
