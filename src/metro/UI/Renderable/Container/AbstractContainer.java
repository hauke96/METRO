...
public abstract class AbstractContainer extends CloseObservable
{
	...
	private interface Notifier
	{
		 ...
		 * 
		 * @param control
		 *            The control element, which should be notified.
	...
	/**
	 * Creates a new container. Will throw an {@code UninitiatedClassException} when the registration service is not initiated via
	 * {@link #setContainerRegistrationService(ContainerRegistrationService)}.
	 */
	 ...
	 *            The new registration service for this container.
	 */
	 ...
	 * 
	 * @param aboveContainer
	 *            The container this is above of. When {@code null} is being passed, the current order will be removed.
	 * @throws ContainerPositioningConflict
	 *             When the below-relation is in conflict with the one of another container (e.g. two container are below each other)
	 */
	 ...
	 *            The notification function which should be executed.
