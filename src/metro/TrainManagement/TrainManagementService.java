...
public class TrainManagementService implements Observer
{
	 ...
	 * 
	 * @param trainName
	 *            The name of the train that should be removed.
	 */
	 ...
	 * 
	 * @param train
	 *            The template train that should be added.
	 */
	 ...
	 * 
	 * @param lineName
	 *            The name of the trains that should be removed from the list.
	 */
